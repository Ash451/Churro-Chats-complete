...
console.log(like)
button_tag=`<button style="border-radius:70%; height:50px" class="btn btn-danger" id=${firebase_message_id} value=${like} onclick= update(this.id)><span class="glyphicon glyphicon-heart"></span> ${like}</button><hr>`
